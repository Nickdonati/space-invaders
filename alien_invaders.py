...
from bullet_ship_2 import Bullet_2
...
class AlienInvaders:
    ...
    def _update_screen(self):
        ...
        self.screen.blit(self.settings.image, self.settings.image.get_rect())
        self.ship.blitme()
        self.ship_2.blitme()
    ...
    def _check_keydown_events(self, event):
        ...
        #player 2
            ...
            self.ship_2.moving_right = True
        elif event.key == pygame.K_a:
            self.ship_2.moving_left = True
    ...
    def _check_keyup_events(self, event):
        if event.key == pygame.K_RIGHT:
            ...
            self.ship_2.moving_right = False
        elif event.key == pygame.K_a:
            self.ship_2.moving_left = False
    ...
    def _fire_bullet(self):
        ...
        fire()
        Timer(0.1, fire).start()
        Timer(0.2, fire).start()

    def _fire_bullet_2(self):
        """Create a new bullet and add it to the bullets group."""
        def fire():
            bullet_sound = mixer.Sound('sound/shoot.wav')
    ...
    def _check_bullet_alien_collisions(self):
        ...
        if not self.aliens:
            ...
            self.bullets.empty()
            self._create_fleet()
            self.settings.increase_speed(self)
    ...
    def _ship_hit(self):
        ...
        if self.stats.ships_left > 0:
            ...
            # Create a new fleet and d the ship.
            self._create_fleet()
            self.ship.center_ship()
            self.ship_2.pos_left_ship_2()
